      ...
      <nav className="flex h-[80px] w-full backdrop-blur-sm fixed justify-center items-center z-20">
        <div className="container w-[1300px] mx-[70px] flex justify-between items-center">
          ...
          <ul className="flex space-x-4 items-center font-roboto mx-[24px]">
            <li>
              <Link href="/" className="text-white font-medium text-[18px] hover:text-[#FFC947] active:text-[#FFC947] focus:text-[#FFC947]">
                Home
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/BookingCheck" className="text-white font-medium text-[18px] hover:text-[#FFC947] active:text-[#FFC947] focus:text-[#FFC947]">
                Booking Check
              </Link>
            </li>
            <li>
              <Link href="/AboutUs" className="text-white font-medium text-[18px] hover:text-[#FFC947] active:text-[#FFC947] focus:text-[#FFC947]">
                About Us
              </Link>
            </li>
            <li>
